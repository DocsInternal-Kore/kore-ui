...
public class BotButtonOuterModel implements MultiSelectBase {
    String type;
    String url;
    String title;
    String payload;
    String name;
    BotPostBackModel botOptionPostBackModel;
    ...
    public ImageOuterModel getImage() {
        return image;
    }

    public void setImage(ImageOuterModel image) {
        this.image = image;
    }

    private ImageOuterModel image;
    ...
    public BotPostBackModel getBotOptionPostBackModel() {
        return botOptionPostBackModel;
    }

    public void setBotOptionPostBackModel(BotPostBackModel botOptionPostBackModel) {
